<ul class="menu">
    ...
    @foreach($menus as $menu)
        @if( $parentBef == "") <!-- This is a parent menu item -->
        <li class="sidebar-item has-sub">
            <a href="#" class='sidebar-link'>
                <i class="bi bi-person-badge-fill"></i>
                <span>{{ $menu->name }}</span>
            </a>               
            <ul class="submenu submenu_{{ $menu->id }}">  
            @php
                $parentBef = $menu->id;
            @endphp              
        @elseif( $parentBef == $menu->parent_id )
            <li class="submenu-item">
                <a href="{{ route($menu->route) }}" class="submenu-link">{{ $menu->name }}</a>
            </li>
            @php
                $parentBef = $menu->parent_id;
            @endphp 
        @else
            @php
                $parentBef = $menu->parent_id;
    ...
    <!-- <li class="sidebar-item has-sub">
        ...
        <ul class="submenu ">
            <li class="submenu-item">
                <a href="auth-forgot-password.html" class="submenu-link">User</a>
            </li>

            <li class="submenu-item">
                <a href="{{ route('programs.index') }}" class="submenu-link">Menu</a>
            </li>
            <li class="submenu-item">
                <a href="{{ route('user-access.index') }}" class="submenu-link">User Access</a>
            </li>
        </ul>
    </li> -->
    @endif
