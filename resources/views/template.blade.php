...
<head>
    ...
    <title>{{ $pageTitle ?? 'Dashboard' }} - Ibrahim Group</title>
    ...
    <style>
        ...
        /* Additional styles for smaller sidebar */
        .sidebar.small {
        ...
        .main.expanded {
            margin-left: 60px; /* Adjust to match the new sidebar size */
        }
...
<body>
    ...
    <div id="app">
        <div id="sidebar" class="sidebar">
            <div class="sidebar-wrapper side active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ route('dashboard') }}"><img src="/assets/image/aqiqah.png" style="width: 80%; height:10%;" alt="Logo" srcset=""></a>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Handle sidebar resize toggle
            var toggleSidebarButton = document.getElementById('toggle-sidebar-size');
            var sidebar = document.getElementById('sidebar');
            var main = document.getElementById('main');

            // Toggle sidebar size and main content size
